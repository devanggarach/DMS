...
def QRSave(**kwargs):
    ...
    #url.png("../../media/{}/qrcode/{}".format(businessname,fname), scale = 4)
    img=Image.open("../../media/{}/qrcode/{}".format(businessname,fname),'r')
    ...
    #background.save("../../media/{}/qrcode/{}".format(businessname,fname))
